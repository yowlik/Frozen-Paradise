...
import com.tencent.igr.cl.Appa.Companion.MAIN_ID
import com.tencent.igr.databinding.ActivityWebsterBinding
...
class Webster : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebsterBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebsterBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "frozenparadise.xyz/go.php?to=2&"
